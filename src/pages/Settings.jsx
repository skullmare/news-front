			...
			<div className="rounded-xl p-4 sm:p-6 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700">
				...
				<div className="grid gap-4">
					<label className="grid gap-2">
						...
						<textarea
							className="w-full min-h-[120px] rounded-md bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/40 p-3 outline-none"
							value={prompt}
			...
			<div className="rounded-xl p-4 sm:p-6 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700">
				...
				<div className="flex flex-col sm:flex-row gap-2 sm:items-end">
					...
					<button
						...
						onClick={addChannel}
						disabled={!newChannel || addingChannel}
					>
						{addingChannel ? (
							<>
								<LoadingSpinner />
