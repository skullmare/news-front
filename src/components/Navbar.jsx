			...
			<div className="backdrop-blur-md bg-white/70 dark:bg-slate-900/60 border-b border-slate-200/60 dark:border-slate-700/60">
				<div className="container mx-auto px-3 sm:px-4 md:px-6 max-w-5xl h-16 flex items-center justify-between">
					<div className="flex items-center gap-2">
						...
						<Link to="/post/add" className="inline-flex items-center gap-2 rounded-md border border-slate-300 dark:border-slate-600 px-3 py-1.5 text-sm sm:text-base hover:bg-slate-100 dark:hover:bg-slate-800 transition">
							<span>+ Новость</span>
						</Link>
					</div>
